...
class RequestBootstrapTests(unittest.TestCase):
    ...
    def test_bootstrap_task_from_request_creates_runnable_workspace(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            agents_text = (bootstrapped / "AGENTS.md").read_text(encoding="utf-8")
            self.assertIn("Model Selection API Reference", agents_text)
            self.assertIn("Do not hardcode models from memory", agents_text)
